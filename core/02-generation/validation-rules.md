...
**Everything here is structural. The annotations themselves are never verified against the text** — see [`DESIGN.md`](../DESIGN.md) §6 for the live case where all five English sentences claimed no creative addition while inventing a sunset.
